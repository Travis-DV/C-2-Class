...
namespace OrderOptionsMaintenance
{
    public partial class frmOptionsMaint : Form
    {
        ...
        private void frmOptionsMaint_Load(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(options.GetDisplayText());
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (IsValidData())
            {
                try
                {
                    ...
                    if (chkNewOption.Checked == true)
                    {
                        data.AddOrderOptions(options);
                    }
                    else if (chkNewOption.Checked != true)
                    {
                        data.UpdateOrderOptions(options);
                    }
